<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.Master" AutoEventWireup="true" CodeBehind="Kapalicarsilar.aspx.cs" Inherits="Eticaret.admin.Kapalicarsilar" %>
...
&nbsp;&nbsp;&nbsp;&nbsp; Kapalıçarşı Ekleme Paneli</div>
        <asp:Panel ID="pnl_kategoriEkle" runat="server" BackColor="#669999" ForeColor="White">
            <table class="auto-style1">
                <tr>
                    <td class="auto-style2" style="text-align: right">Kapalıçarşı Adı:<br />
                        <br />
                        <br />
                        </td>
                    <td>
...
&nbsp;&nbsp;&nbsp;
            <asp:Button ID="btn_kdEksi" runat="server"  Text="-" Width="18px" OnClick="btn_kdEksi_Click" />
             &nbsp;&nbsp;&nbsp;&nbsp; Kapalıçarşı Düzenleme/Silme Paneli</div>
                    ...
                    <table class="auto-style1">
                        <tr>
                            <td class="auto-style3">
                                <asp:Literal ID="Literal1" runat="server" Text='<%# Eval("kapalicarsiAdi") %>'></asp:Literal>
                            </td>
                            <td class="auto-style4">
                               <a href="kcarsiGuncelle.aspx?kapalicarsiID=<%#Eval("kapalicarsiID") %>"> <img alt="" class="auto-style5" src="../tema/düzenle.jpg" /></a>
                            </td>
                            <td>
                                <a href="Kapalicarsilar.aspx?kapalicarsiID=<%#Eval("kapalicarsiID") %>&islem=sil"><img alt="" class="auto-style6" src="../tema/sil%20ikonu.jpg" /></a>
                            </td>
                        </tr>
                    </table>
                </ItemTemplate>
